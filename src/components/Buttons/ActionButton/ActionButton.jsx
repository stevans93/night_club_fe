...
import EditReservationForm from "../../DashboardComponents/DashboardForms/EditReservationForm/EditReservationForm";
        ...
        {isOpen && (
          <div className="flex flex-col absolute top-9 z-10 w-full bg-[#979797] p-1 rounded-md">
            ...
            <button
              ...
              className="flex items-center bg-white text-[#20339C] gap-1 px-2 py-2 rounded-md hover:bg-[#979797]"
            >
