            ...
            <form onSubmit={formik.handleSubmit} className='flex flex-col md:flex-row gap-4 mt-12'>
                <div>
                    <div className='flex flex-col gap-2 mb-4'>
                        <label>Ime i Prezime {' '} <span className='text-[14px] text-red-600'> {showError('fullName')} </span></label>
                ...
                <div className='flex flex-col gap-2'>
                    <label>Poruka {' '} <span className='text-[14px] text-red-600'> {showError('message')} </span></label>
                    ...
                    <button type='submit' className='flex items-center justify-center border border-primary bg-primary text-white hover:bg-primary rounded-[4px] mt-3 py-2 hover:text-white'>Pošalji <BsSend className='ml-2' /></button>
                </div>
