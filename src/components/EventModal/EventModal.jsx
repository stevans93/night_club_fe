    ...
    <>
      {props.showEventModal && (
        <div className="flex text-center reservation w-full">
          ...
          >
            <Modal.Body className="m-0 p-0 h-h500">
              <div className="flex h-full reservation xs:flex-col lg:flex-row">
                <div className="flex xs:h-fit lg:h-full eventImg lg:w-45 xs:w-full xs:order-2 lg:order-1">
                  <img className="flex w-full" src={props.event.image} alt="" />
                </div>
                <div className="flex h-full flex-col xs:items-center lg:flex-1 px-6 relative xs:order-1 lg:order-2 xs:gap-4 xl:gap-0 eventBody">
                  ...
                  <div className="flex flex-col w-1/2 items-center lg:mt-auto  rounded-3xl lg:py-10 gap-6">
