        ...
        <div>
            <form onSubmit={formik.handleSubmit} className='flex flex-col items-center gap-2'>
                <div className='flex flex-col lg:items-start gap-2'>
                    ...
                    <input name='email' type="email" value={formik.values.email} onChange={formik.handleChange} className='border border-others w-[300px] lg:w-[616px] focus:bg-white rounded-lg p-3' placeholder='Insert email...' />
                </div>
                ...
                <div className='flex flex-col lg:items-start gap-2 relative'>
                    ...
                    <input name='password' type={visibility ? "password" : "text"} value={formik.values.password} onChange={formik.handleChange} className='border border-others w-[300px] lg:w-[616px] bg-white rounded-lg p-3' placeholder='Insert password...' />
                    {visibility ? (
